...
const modelCode = `import * as THREE from 'three';
...
fs.writeFileSync('app/components/exercise/AnatomyViewer/AnatomyModel.ts', modelCode, 'utf8');
console.log('AnatomyModel.ts written.');
