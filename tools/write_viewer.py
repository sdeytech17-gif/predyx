...
.viewToggleGroup {
  display: flex;
  align-items: center;
  background-color: rgba(20, 26, 38, 0.90);
  border: 1px solid rgba(255, 255, 255, 0.12);
  border-radius: var(--radius-full);
  padding: 2px;
  backdrop-filter: blur(10px);
...
.studioGlow {
  ...
  width: 320px;
  height: 480px;
  background: radial-gradient(ellipse at center, rgba(56, 189, 248, 0.12) 0%, rgba(245, 158, 11, 0.08) 45%, transparent 70%);
  filter: blur(30px);
  pointer-events: none;
}
...
print('Success: AnatomyViewer.tsx and AnatomyViewer.module.css updated.')
